...
class CefPrintSettings_N extends CefPrintSettings implements CefNative {
    ...
    public  native static CefPrintSettings_N N_Create();
    public  native void N_Dispose(long self);
    public  native boolean N_IsValid(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native void N_SetOrientation(long self, boolean landscape);
    public  native boolean N_IsLandscape(long self);
    public  native void N_SetPrinterPrintableArea(long self,
            Dimension physical_size_device_units, Rectangle printable_area_device_units,
            boolean landscape_needs_flip);
    public  native void N_SetDeviceName(long self, String name);
    public  native String N_GetDeviceName(long self);
    public  native void N_SetDPI(long self, int dpi);
    public  native int N_GetDPI(long self);
    public  native void N_SetPageRanges(long self, Vector<CefPageRange> ranges);
    public  native int N_GetPageRangesCount(long self);
    public  native void N_GetPageRanges(long self, Vector<CefPageRange> ranges);
    public  native void N_SetSelectionOnly(long self, boolean selection_only);
    public  native boolean N_IsSelectionOnly(long self);
    public  native void N_SetCollate(long self, boolean collate);
    public  native boolean N_WillCollate(long self);
    public  native void N_SetColorModel(long self, ColorModel model);
    public  native ColorModel N_GetColorModel(long self);
    public  native void N_SetCopies(long self, int copies);
    public  native int N_GetCopies(long self);
    public  native void N_SetDuplexMode(long self, DuplexMode mode);
    public  native DuplexMode N_GetDuplexMode(long self);
}
