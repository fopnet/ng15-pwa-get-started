...
public interface CefDragHandler {
     ...
     *
     */
    public static  class DragOperationMask {
        public static  int DRAG_OPERATION_NONE = 0;
        public static  int DRAG_OPERATION_COPY = 1;
        public static  int DRAG_OPERATION_LINK = 2;
        public static  int DRAG_OPERATION_GENERIC = 4;
        public static  int DRAG_OPERATION_PRIVATE = 8;
        public static  int DRAG_OPERATION_MOVE = 16;
        public static  int DRAG_OPERATION_DELETE = 32;
        public static  int DRAG_OPERATION_EVERY = Integer.MAX_VALUE;
    }
