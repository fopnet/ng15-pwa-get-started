...
class CefURLRequest_N extends CefURLRequest implements CefNative {
    ...
    public  CefRequest request_;
    public  CefURLRequestClient client_;
    ...
    public static  CefURLRequest createNative(CefRequest request, CefURLRequestClient client) {
    ...
    public  native void N_Create(CefRequest request, CefURLRequestClient client);
    public  native void N_Dispose(long self);
    public  native Status N_GetRequestStatus(long self);
    public  native ErrorCode N_GetRequestError(long self);
    public  native CefResponse N_GetResponse(long self);
