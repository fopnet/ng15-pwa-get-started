...
class CefCookieManager_N extends CefCookieManager implements CefNative {
    ...
    static synchronized  CefCookieManager_N getGlobalManagerNative() {
    ...
    public  native boolean N_VisitAllCookies(long self, CefCookieVisitor visitor);
    public  native boolean N_VisitUrlCookies(
            long self, String url, boolean includeHttpOnly, CefCookieVisitor visitor);
    public  native boolean N_SetCookie(long self, String url, CefCookie cookie);
    public  native boolean N_DeleteCookies(long self, String url, String cookieName);
    public  native boolean N_FlushStore(long self, CefCompletionCallback handler);
}
