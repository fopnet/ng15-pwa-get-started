...
class CefPostDataElement_N extends CefPostDataElement implements CefNative {
    ...
    public  native static CefPostDataElement_N N_Create();
    public  native void N_Dispose(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native void N_SetToEmpty(long self);
    public  native void N_SetToFile(long self, String fileName);
    public  native void N_SetToBytes(long self, int size, byte[] bytes);
    public  native Type N_GetType(long self);
    public  native String N_GetFile(long self);
    public  native int N_GetBytesCount(long self);
    public  native int N_GetBytes(long self, int size, byte[] bytes);
}
