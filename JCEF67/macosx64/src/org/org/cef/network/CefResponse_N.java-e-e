...
class CefResponse_N extends CefResponse implements CefNative {
    ...
    public  native static CefResponse_N N_Create();
    public  native void N_Dispose(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native ErrorCode N_GetError(long self);
    public  native void N_SetError(long self, ErrorCode errorCode);
    public  native int N_GetStatus(long self);
    public  native void N_SetStatus(long self, int status);
    public  native String N_GetStatusText(long self);
    public  native void N_SetStatusText(long self, String statusText);
    public  native String N_GetMimeType(long self);
    public  native void N_SetMimeType(long self, String mimeType);
