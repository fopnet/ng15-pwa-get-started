...
public abstract class CefRequest {
    ...
    public static  class CefUrlRequestFlags {
         ...
         */
        public static  int UR_FLAG_SKIP_CACHE = 1 << 0;

        /**
         * If set user name, password, and cookies may be sent with the request, and
         * cookies may be saved from the response.
         */
        public static  int UR_FLAG_ALLOW_CACHED_CREDENTIALS = 1 << 1;

        /**
         * If set upload progress events will be generated when a request has a body.
         */
        public static  int UR_FLAG_REPORT_UPLOAD_PROGRESS = 1 << 3;

        /**
         * If set the headers sent and received for the request will be recorded.
         */
        public static  int UR_FLAG_REPORT_RAW_HEADERS = 1 << 5;

        /**
         *  If set the CefURLRequestClient.onDownloadData method will not be called.
         */
        public static  int UR_FLAG_NO_DOWNLOAD_DATA = 1 << 6;
         ...
         */
        public static  int UR_FLAG_NO_RETRY_ON_5XX = 1 << 7;
    }
