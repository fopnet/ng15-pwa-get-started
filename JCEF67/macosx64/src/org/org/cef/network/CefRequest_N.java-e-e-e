...
class CefRequest_N extends CefRequest implements CefNative {
    ...
    public  native static CefRequest_N N_Create();
    public  native void N_Dispose(long self);
    public  native long N_GetIdentifier(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native String N_GetURL(long self);
    public  native void N_SetURL(long self, String url);
    public  native String N_GetMethod(long self);
    public  native void N_SetMethod(long self, String method);
    public  native void N_SetReferrer(long self, String url, ReferrerPolicy policy);
    public  native String N_GetReferrerURL(long self);
    public  native ReferrerPolicy N_GetReferrerPolicy(long self);
    public  native CefPostData N_GetPostData(long self);
    public  native void N_SetPostData(long self, CefPostData postData);
    public  native String N_GetHeaderByName(long self, String name);
    public  native void N_SetHeaderByName(
            long self, String name, String value, boolean overwrite);
    public  native void N_GetHeaderMap(long self, Map<String, String> headerMap);
    public  native void N_SetHeaderMap(long self, Map<String, String> headerMap);
    public  native void N_Set(long self, String url, String method, CefPostData postData,
            Map<String, String> headerMap);
    public  native int N_GetFlags(long self);
    public  native void N_SetFlags(long self, int flags);
    public  native String N_GetFirstPartyForCookies(long self);
    public  native void N_SetFirstPartyForCookies(long self, String url);
    public  native ResourceType N_GetResourceType(long self);
    public  native TransitionType N_GetTransitionType(long self);
}
