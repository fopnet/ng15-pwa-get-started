...
class CefPostData_N extends CefPostData implements CefNative {
    ...
    public  native static CefPostData_N N_Create();
    public  native void N_Dispose(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native int N_GetElementCount(long self);
    public  native void N_GetElements(long self, Vector<CefPostDataElement> elements);
    public  native boolean N_RemoveElement(long self, CefPostDataElement element);
    public  native boolean N_AddElement(long self, CefPostDataElement element);
    public  native void N_RemoveElements(long self);
}
