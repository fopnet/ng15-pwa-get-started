...
class CefFrame_N extends CefNativeAdapter implements CefFrame {
    ...
    public  native String N_GetName(long self);
    public  native boolean N_IsMain(long self);
    public  native boolean N_IsValid(long self);
    public  native boolean N_IsFocused(long self);
    public  native CefFrame N_GetParent(long self);
    public  native void N_ExecuteJavaScript(long self, String code, String url, int line);
    public  native void N_Undo(long self);
    public  native void N_Redo(long self);
    public  native void N_Cut(long self);
    public  native void N_Copy(long self);
    public  native void N_Paste(long self);
}
