...
class CefDropTargetListener implements DropTargetListener {
    public CefBrowser_N browser_;
    public CefDragData dragData_ = null;
    public int dragOperations_ = CefDragData.DragOperations.DRAG_OPERATION_COPY;
    public int dragModifiers_ = EventFlags.EVENTFLAG_NONE;
    public int acceptOperations_ = DnDConstants.ACTION_COPY;
    ...
    public void CreateDragData(DropTargetDragEvent event) {
        assert dragData_ == null;
        dragData_ = createDragData(event);
        dropActionChanged(event);
    }

    public void AssertDragData() {
        assert dragData_ != null;
    }
    ...
    public static CefDragData createDragData(DropTargetDragEvent event) {
