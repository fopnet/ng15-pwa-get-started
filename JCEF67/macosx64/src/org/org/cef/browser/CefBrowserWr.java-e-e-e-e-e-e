...
class CefBrowserWr extends CefBrowser_N {
    ...
    public Component component_ = null;
    public Rectangle content_rect_ = new Rectangle(0, 0, 0, 0);
    public long window_handle_ = 0;
    public boolean justCreated_ = false;
    public double scaleFactor_ = 1.0;
    public Timer delayedUpdate_ = new Timer(100, new ActionListener() {
        @Override
    ...
    public CefWindowHandlerAdapter win_handler_ = new CefWindowHandlerAdapter() {
        public Point lastPos = new Point(-1, -1);
        public long[] nextClick = new long[MouseInfo.getNumberOfButtons()];
        public int[] clickCnt = new int[MouseInfo.getNumberOfButtons()];
    ...
    public boolean createBrowserIfRequired(boolean hasParent) {
