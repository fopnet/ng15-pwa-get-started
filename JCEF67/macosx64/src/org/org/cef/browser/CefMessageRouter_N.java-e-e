...
class CefMessageRouter_N extends CefMessageRouter implements CefNative {
    ...
    public  native static CefMessageRouter_N N_Create(CefMessageRouterConfig config);
    public  native void N_Dispose(long self);
    public  native boolean N_AddHandler(
            long self, CefMessageRouterHandler handler, boolean first);
    public  native boolean N_RemoveHandler(long self, CefMessageRouterHandler handler);
    public  native void N_CancelPending(
