...
abstract class CefBrowser_N extends CefNativeAdapter implements CefBrowser {
    public volatile boolean isPending_ = false;
    public  CefClient client_;
    public  String url_;
    public  CefRequestContext request_context_;
    public volatile CefBrowser_N parent_ = null;
    public volatile Point inspectAt_ = null;
    public volatile CefBrowser_N devTools_ = null;
    public boolean closeAllowed_ = false;
    public volatile boolean isClosed_ = false;
    public volatile boolean isClosing_ = false;
    ...
    public abstract CefBrowser_N createDevToolsBrowser(CefClient client, String url,
            CefRequestContext context, CefBrowser_N parent, Point inspectAt);

    /**
     * Create a new browser.
     */
    public void createBrowser(CefClientHandler clientHandler, long windowHandle, String url,
     ...
     */
    public void notifyBrowserCreated() {
        isPending_ = true;
    }
     ...
     */
    public  void createDevTools(CefBrowser_N parent, CefClientHandler clientHandler,
     ...
     */
    public  long getWindowHandle(long surfaceHandle) {
        try {
     ...
     * This method is only used when window rendering is disabled.
     */
    public  void dragTargetDragOver(Point pos, int modifiers, int allowedOps) {
        try {
     ...
     * This method is only used when window rendering is disabled.
     */
    public  void dragTargetDrop(Point pos, int modifiers) {
        try {
    ...
    public  void setParent(long windowHandle, Component canvas) {
        if (isClosing_ || isClosed_) return;
    ...
    public  native boolean N_CreateBrowser(CefClientHandler clientHandler, long windowHandle,
            String url, boolean osr, boolean transparent, Component canvas,
            CefRequestContext context);
    public  native boolean N_CreateDevTools(CefBrowser parent, CefClientHandler clientHandler,
            long windowHandle, boolean osr, boolean transparent, Component canvas, Point inspectAt);
    public  native long N_GetWindowHandle(long surfaceHandle);
    public  native boolean N_CanGoBack();
    public  native void N_GoBack();
    public  native boolean N_CanGoForward();
    public  native void N_GoForward();
    public  native boolean N_IsLoading();
    public  native void N_Reload();
    public  native void N_ReloadIgnoreCache();
    public  native void N_StopLoad();
    public  native int N_GetIdentifier();
    public  native CefFrame N_GetMainFrame();
    public  native CefFrame N_GetFocusedFrame();
    public  native CefFrame N_GetFrame(long identifier);
    public  native CefFrame N_GetFrame2(String name);
    public  native Vector<Long> N_GetFrameIdentifiers();
    public  native Vector<String> N_GetFrameNames();
    public  native int N_GetFrameCount();
    public  native boolean N_IsPopup();
    public  native boolean N_HasDocument();
    public  native void N_ViewSource();
    public  native void N_GetSource(CefStringVisitor visitor);
    public  native void N_GetText(CefStringVisitor visitor);
    public  native void N_LoadRequest(CefRequest request);
    public  native void N_LoadURL(String url);
    public  native void N_ExecuteJavaScript(String code, String url, int line);
    public  native String N_GetURL();
    public  native void N_Close(boolean force);
    public  native void N_SetFocus(boolean enable);
    public  native void N_SetWindowVisibility(boolean visible);
    public  native double N_GetZoomLevel();
    public  native void N_SetZoomLevel(double zoomLevel);
    public  native void N_RunFileDialog(FileDialogMode mode, String title,
            String defaultFilePath, Vector<String> acceptFilters, int selectedAcceptFilter,
            CefRunFileDialogCallback callback);
    public  native void N_StartDownload(String url);
    public  native void N_Print();
    public  native void N_PrintToPDF(
            String path, CefPdfPrintSettings settings, CefPdfPrintCallback callback);
    public  native void N_Find(
            String searchText, boolean forward, boolean matchCase, boolean findNext);
    public  native void N_StopFinding(boolean clearSelection);
    public  native void N_CloseDevTools();
    public  native void N_ReplaceMisspelling(String word);
    public  native void N_WasResized(int width, int height);
    public  native void N_Invalidate();
    public  native void N_SendKeyEvent(KeyEvent e);
    public  native void N_SendMouseEvent(MouseEvent e);
    public  native void N_SendMouseWheelEvent(MouseWheelEvent e);
    public  native void N_DragTargetDragEnter(
            CefDragData dragData, Point pos, int modifiers, int allowed_ops);
    public  native void N_DragTargetDragOver(Point pos, int modifiers, int allowed_ops);
    public  native void N_DragTargetDragLeave();
    public  native void N_DragTargetDrop(Point pos, int modifiers);
    public  native void N_DragSourceEndedAt(Point pos, int operation);
    public  native void N_DragSourceSystemDragEnded();
    public  native void N_UpdateUI(Rectangle contentRect, Rectangle browserRect);
    public  native void N_SetParent(long windowHandle, Component canvas);
    public  native void N_NotifyMoveOrResizeStarted();
}
