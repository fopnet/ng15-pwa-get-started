...
class CefBrowserOsr extends CefBrowser_N implements CefRenderHandler {
    ...
    public void createGLCanvas() {
        ...
        canvas_ = new GLCanvas(glcapabilities) {
            public Method scaleFactorAccessor = null;
    ...
    public void onPaint(CefBrowser browser, boolean popup, Rectangle[] dirtyRects,
        ...
        // if window is closing, canvas_ or opengl context could be null
         GLContext context = canvas_ != null ? canvas_.getContext() : null;
    ...
    public static  class SyntheticDragGestureRecognizer extends DragGestureRecognizer {
    ...
    public CompletableFuture<BufferedImage> createScreenshot(boolean nativeResolution) {
        ...
        // BufferedImage contains the grabbed image.
         Callable<BufferedImage> pixelGrabberCallable = new Callable<BufferedImage>() {
            @Override
