...
public class CefClient extends CefClientHandler
    ...
    public HashMap<Integer, CefBrowser> browser_ = new HashMap<Integer, CefBrowser>();
    ...
    public CefPrintHandler printHandler_ = null;
    ...
    @Override
    public CefBrowser getBrowser(int identifier) {
    ...
    public void cleanupBrowser(int identifier) {
        synchronized (browser_) {
            if (identifier >= 0) {
