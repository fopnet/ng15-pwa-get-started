...
class CefCommandLine_N extends CefNativeAdapter implements CefCommandLine {
    ...
    public  native void N_Reset(long self);
    public  native String N_GetProgram(long self);
    public  native void N_SetProgram(long self, String program);
    public  native boolean N_HasSwitches(long self);
    public  native boolean N_HasSwitch(long self, String name);
    public  native String N_GetSwitchValue(long self, String name);
    public  native Map<String, String> N_GetSwitches(long self);
    public  native void N_AppendSwitch(long self, String name);
    public  native void N_AppendSwitchWithValue(long self, String name, String value);
    public  native boolean N_HasArguments(long self);
    public  native Vector<String> N_GetArguments(long self);
    public  native void N_AppendArgument(long self, String argument);
}
