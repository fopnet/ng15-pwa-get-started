...
class CefContextMenuParams_N extends CefNativeAdapter implements CefContextMenuParams {
    ...
    public  native int N_GetXCoord(long self);
    public  native int N_GetYCoord(long self);
    public  native int N_GetTypeFlags(long self);
    public  native String N_GetLinkUrl(long self);
    public  native String N_GetUnfilteredLinkUrl(long self);
    public  native String N_GetSourceUrl(long self);
    public  native boolean N_HasImageContents(long self);
    public  native String N_GetPageUrl(long self);
    public  native String N_GetFrameUrl(long self);
    public  native String N_GetFrameCharset(long self);
    public  native MediaType N_GetMediaType(long self);
    public  native int N_GetMediaStateFlags(long self);
    public  native String N_GetSelectionText(long self);
    public  native String N_GetMisspelledWord(long self);
    public  native boolean N_GetDictionarySuggestions(long self, Vector<String> suggestions);
    public  native boolean N_IsEditable(long self);
    public  native boolean N_IsSpellCheckEnabled(long self);
    public  native int N_GetEditStateFlags(long self);
}
