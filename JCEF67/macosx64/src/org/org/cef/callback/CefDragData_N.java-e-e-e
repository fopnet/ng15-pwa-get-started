...
class CefDragData_N extends CefDragData implements CefNative {
    ...
    public  native static CefDragData_N N_Create();
    public  native CefDragData_N N_Clone(long self);
    public  native void N_Dispose(long self);
    public  native boolean N_IsReadOnly(long self);
    public  native boolean N_IsLink(long self);
    public  native boolean N_IsFragment(long self);
    public  native boolean N_IsFile(long self);
    public  native String N_GetLinkURL(long self);
    public  native String N_GetLinkTitle(long self);
    public  native String N_GetLinkMetadata(long self);
    public  native String N_GetFragmentText(long self);
    public  native String N_GetFragmentHtml(long self);
    public  native String N_GetFragmentBaseURL(long self);
    public  native int N_GetFileContents(long self, OutputStream writer);
    public  native String N_GetFileName(long self);
    public  native boolean N_GetFileNames(long self, Vector<String> names);
    public  native void N_SetLinkURL(long self, String url);
    public  native void N_SetLinkTitle(long self, String title);
    public  native void N_SetLinkMetadata(long self, String data);
    public  native void N_SetFragmentText(long self, String text);
    public  native void N_SetFragmentHtml(long self, String html);
    public  native void N_SetFragmentBaseURL(long self, String baseUrl);
    public  native void N_ResetFileContents(long self);
    public  native void N_AddFile(long self, String path, String displayName);
